      ...
      <div aria-hidden="true" aria-labelledby="myModalLabel1" role="dialog" tabindex="-1" id="changeModal" class="modal fade">
          <div class="modal-dialog">
              <div class="modal-content">
                  ...
                  <div class="modal-body">
                      <p>学号</p>
                      <input type="text" id="c_teacher_ID" placeholder="" autocomplete="off" class="form-control placeholder-no-fix">
                  ...
                  <div class="modal-body">
                      <p>电话</p>
                      <input type="text" id="c_t_tel" placeholder="" autocomplete="off" class="form-control placeholder-no-fix">
      ...
      <div aria-hidden="true" aria-labelledby="myModalLabel2" role="dialog" tabindex="-1" id="addModal" class="modal fade">
          <div class="modal-dialog">
              <div class="modal-content">
                  ...
                  <div class="modal-body">
                      <input type="text" id="t_name" placeholder="输入教师姓名" autocomplete="off" class="form-control placeholder-no-fix">

                  </div>
                  <div class="modal-body">
                      <input type="text" id="t_id" placeholder="输入教师工号" autocomplete="off" class="form-control placeholder-no-fix">

                  </div>
                  <div class="modal-body">
                      <input type="text" id="t_school" placeholder="输入教师学校" autocomplete="off" class="form-control placeholder-no-fix">

                  </div>
                  <div class="modal-body">
                      <input type="text" id="t_college" placeholder="输入学生学院" autocomplete="off" class="form-control placeholder-no-fix">

                  </div>

                  <div class="modal-body">
                      <input type="text" id="t_tel" placeholder="输入教师联系方式" autocomplete="off" class="form-control placeholder-no-fix">
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper">
              <h3><i class="fa fa-angle-right"></i> 教师管理</h3>

              <div class="row mt">
                  <div class="col-md-12">
                      <div class="content-panel">
                          <table class="table table-striped table-advance table-hover">
                              <button  id="add_button" type="button" class="btn btn-info">添加老师</button>
                              <hr>
                              <thead>
                              <tr>
                                  <th><i class="fa"></i> 姓名</th>
                                  <th><i class="fa"></i> 工号</th>
      ...
      $(function(){
          $("#changesubmit").click(function () {
              $.ajax({
                  type: "POST",
                  contentType: 'application/json;charset=utf-8',
                  url: "/pages/changeTeacher",
                  dataType: "json",
                  async:false,
                  data: JSON.stringify({
                      "new_id":id,
                      "new_teacher_ID": $("#c_teacher_ID").val(),
                      "new_name": $("#c_name").val(),
          ...
          $("#addsubmit").click(function () {
              $.ajax({
                  type: "POST",
                  contentType: 'application/json;charset=utf-8',
                  url: "/pages/addTeacher",
                  dataType: "json",
                  async:false,
                  data: JSON.stringify({
                      "new_teacher_ID": $("#t_id").val(),
                      "new_name": $("#t_name").val(),
                      "new_school": $("#t_school").val(),
                      "new_college": $("#t_college").val(),
                      "new_tel": $("#t_tel").val(),
                  }),
                  success: function (data) {
                  }
