              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          ...
                          <li class="active"><a  href="todo_list.jsp">Todo List</a></li>
                      </ul>
                  </li>
                  <li class="sub-menu">
                      <a href="javascript:;" >
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          <li><a  href="studentManage.jsp">Basic Table</a></li>
      ...
      *********************************************************************************************************************************************************** -->
				              ...
				              <tbody>
				                <tr>
				           			<td>
				                        ...
				                        <a href="index.jsp#">Send invoice</a></span>
				                ...
				                <tr>
				           			<td>
				                        <span class="check"><input type="checkbox" class="checked"></span>
				                        <a href="index.jsp#">Check messages</a></span>
				                        <button class="close" aria-hidden="true" data-dismiss="alert" type="button">×</button>
									</td>
				                </tr>
				                <tr>
				            		<td>
				                        <span class="check"><input type="checkbox" class="checked"></span>
				                        <a href="index.jsp#">Pay bills</a></span>
				                        <button class="close" aria-hidden="true" data-dismiss="alert" type="button">×</button>
									</td>
				                </tr>
				                <tr>
				            		<td>
				                        <span class="check"><input type="checkbox" class="checked"></span>
				                        <a href="index.jsp#">Schedule site </a></span>
				                        <button class="close" aria-hidden="true" data-dismiss="alert" type="button">×</button>
									</td>
				                 </tr>
				              </tbody>
	                	...
	                	<div class="panel-heading">
                          ...
                          <div class="panel-body">
                              ...
                              <div class=" add-task-row">
                                  <a class="btn btn-success btn-sm pull-left" href="todo_list.jsp#">Add New Tasks</a>
                                  <a class="btn btn-default btn-sm pull-right" href="todo_list.jsp#">See All Tasks</a>
                              </div>
                          </div>
                      </section>
                  </div><!-- /col-md-12-->
      ...
      <footer class="site-footer">
          <div class="text-center">
              ...
              <a href="todo_list.jsp#" class="go-top">
